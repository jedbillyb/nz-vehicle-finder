    ...
    >
      ...
      <header style={{ borderBottom: "1px solid #e5e7eb", background: "#ffffff", position: "sticky", top: 0, zIndex: 40 }}>
        ...
        <div style={{ padding: "10px 24px", display: "flex", alignItems: "center", gap: 16, background: "#ffffff" }}>
          ...
          <a href="https://github.com/jedbillyb/nz-vehicle-finder" target="_blank" rel="noopener noreferrer" style={{ marginLeft: "auto", color: "#6b7280" }}>
      ...
      <div style={{ borderBottom: "1px solid #e5e7eb", background: "#f3f4f6" }}>
        <button
          ...
          style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 24px", background: "#f9fafb", border: "none", borderBottom: filtersExpanded ? "1px solid #e5e7eb" : "none", cursor: "pointer", color: "#4b5563" }}
        >
